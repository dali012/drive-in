...
import { <%= name %>Entity } from '../../../../<%= h.inflection.transform(name, ['pluralize', 'underscore', 'dasherize']) %>/infrastructure/persistence/entities/<%= h.inflection.transform(name, ['underscore', 'dasherize']) %>.entity';
